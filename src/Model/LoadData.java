...
public class LoadData {
	...
	public LoadData() {
		...
		try {
			BufferedImage img = ImageIO.read(new File("D:\\Data-Algorithm-Data-Structure-Project\\res\\images\\minesweeper.png"));
			BufferedImage title = ImageIO.read(new File("D:\\Data-Algorithm-Data-Structure-Project\\res\\images\\icon 1.png"));


			listImage.put("title", title);
